...
namespace ActivEarth.Tests.Competition.Badges
{
    ...
    public class BadgeTest
    {
        ...
        public void TestBadgeGetImagePath()
        {
            ...
            _user.SetStatistic(Statistic.Steps, BadgeConstants.Steps.REQUIREMENTS[BadgeLevels.Platinum]);
            stepBadge.Update();
        ...
        public void TestBadgeGetNextLevelRequirement()
        {
            ...
            _user.SetStatistic(Statistic.Steps, BadgeConstants.Steps.REQUIREMENTS[BadgeLevels.Gold]);
            stepBadge.Update();
