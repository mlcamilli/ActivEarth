...
<asp:Panel ID="_DisplayGraph" runat="server"   
    ...
    style="position: relative; top: 0px; left: 0px; height: 140px; width: 265px;">
    ...
    <asp:Panel ID="_DisplayProgress" runat="server" BorderColor="Black" 
        ...
        style="z-index: 1; left: 5px; top: 30px; position: absolute; height: 40px; width: 248px; bottom: 62px;">
         <eo:ProgressBar ID="_ContestProgress" runat="server" Width="258px"   
            style="z-index: 1; left: 0px; top: 5px; position: absolute; height: 30px; width: 248px" 
            IndicatorColor="ForestGreen"></eo:ProgressBar>
    </asp:Panel>

    <asp:Label ID="_StartLabel" runat="server" Text="Start" 
        style="z-index: 1; left: 7px; top: 78px; position: absolute"></asp:Label>
    <asp:Label ID="_EndLabel" runat="server" Text="Finish" 
        style="z-index: 1; left: 224px; top: 78px; position: absolute"></asp:Label>
</asp:Panel>