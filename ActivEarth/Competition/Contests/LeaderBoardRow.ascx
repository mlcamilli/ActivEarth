...
<asp:Panel ID="_row" runat="server" BackColor="Green" Height="25px" 
    ...
    <asp:Label ID="_position" runat="server" Text="."        
        style="z-index: 1; left: 2px; top: 5px; position: absolute; text-align:right; width: 27px;" 
        Font-Names="Eras Demi ITC" Font-Size="Small"></asp:Label>

    <asp:Label ID="_teamName" runat="server" Text="Name"       
        
        style="z-index: 1; left: 31px; top: 5px; position: absolute; width: 150px;" 
        Font-Names="Eras Demi ITC" Font-Size="Small"></asp:Label>

    <asp:Label ID="_currentScore" runat="server" Text="10000" 
        
        style="z-index: 1; left: 193px; top: 5px; position: absolute; text-align:right; width: 100px;" 
        Font-Names="Eras Demi ITC" Font-Size="Small"></asp:Label>
