<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="OwnedGroupsDisplayTable.ascx.cs" Inherits="ActivEarth.Groups.OwnedGroupsDisplayTable" %>

<asp:Table ID="_ownedGroupsTable" runat="server" BorderStyle="Solid" 
